...
1. Can FindAndDelete be more expressive than plain subset deletion in toy byte
   constructions?
2. Does the actual QSB minimal 9-byte dummy-signature surface expose that
   additional expressivity, or does it collapse back to ordinary subset
   behavior?
"""
...
from bitcoin_tx import QSBScriptBuilder, find_and_delete, push_data  # type: ignore
